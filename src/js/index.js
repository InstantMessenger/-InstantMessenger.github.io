...
const CARDS = [
    ...
    },
    {
        ...
        descript: `Нужно пройти <a href="#" class="box-second__link">опрос</a>:<br>- "Почему я хочу работать с вами"<br>- Свои контакты <br>- еще несколько вопросов <br><br>Мы рассмотрим каждую заявку и обязательно свяжемся с вами!`,
